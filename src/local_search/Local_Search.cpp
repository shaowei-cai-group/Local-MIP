...
Local_Search::Local_Search(const Model_Manager* p_model_manager)
    : m_model_manager(p_model_manager),
      ...
      m_binary_op_stamp_token(0), m_activity_period(4096),
      m_activity_hits(0), m_cur_step(0), m_tabu_base(3),
      m_tabu_variation(10), m_is_found_feasible(false),
      m_current_obj_breakthrough(false), m_last_improve_step(0),
      m_bms_unsat_con(10), m_bms_mtm_unsat_op(2000), m_bms_sat_con(20),
      m_bms_mtm_sat_op(50), m_bms_flip_op(5), m_bms_easy_op(100),
      m_bms_random_op(500), m_best_obj(k_inf),
